...
@section('title', 'Razen Holiday | Profil')
...
@section('content')
        ...
        <div class="col-12 col-md-7">
            ...
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-holiday.admin.profil.index') }}">Profil</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('razen-holiday.admin.profil.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <input type="file" class="dropify" name="logo" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/razen-holiday/logo/'.$profil->logo) }}" data-show-errors="true" required>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        $('#edit_media_sosial_profil_form').submit(function(e){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-holiday.admin.profil.edit-media-sosial-profil') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            ...
                            if(data.success)
                            {
                                new swal({
                                    ...
                                    title: data.success
                                        ...
                                        window.location.href = "{{ route('razen-holiday.admin.profil.index') }}";
                                });
                            }
                        }
                    });
        ...
        $('#tambah_media_sosial_profil_form').submit(function(e){
            e.preventDefault();
            $.ajax({
                url: "{{ route('razen-holiday.admin.profil.tambah-media-sosial-profil') }}",
                method: "POST",
