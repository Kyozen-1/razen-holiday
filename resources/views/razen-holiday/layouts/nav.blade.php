    ...
    <div class="nav-content d-flex">
        ...
        <div class="user-container d-flex">
            ...
            <div class="row mb-1 ms-0 me-0">
                ...
                <ul class="list-unstyled">
                        <li>
                            <a href="{{ route('razen-holiday.logout') }}">
        ...
        <div class="menu-container flex-grow-1">
            <ul id="menu" class="menu">
                <li>
                    @if (request()->routeIs('razen-holiday.admin.dashboard.index'))
                        <a href="{{ route('razen-holiday.admin.dashboard.index') }}" class="active">
                    @else
                ...
                <li>
                    @if (request()->routeIs('razen-holiday.admin.profil.index'))
                        <a href="{{ route('razen-holiday.admin.profil.index') }}" class="active">
                    @else
                        <a href="{{ route('razen-holiday.admin.profil.index') }}">
                    @endif
                        <i data-acorn-icon="home-garage" class="icon" data-acorn-size="18"></i>
                ...
                <li>
                    @if (request()->routeIs('razen-holiday.master-data.media-sosial.index'))
                    ...
                    <ul id="master_data">
                        <li>
                            @if (request()->routeIs('razen-holiday.master-data.media-sosial.index'))
                                <a href="{{ route('razen-holiday.master-data.media-sosial.index') }}" class="active">
                            @else
                                <a href="{{ route('razen-holiday.master-data.media-sosial.index') }}">
                            @endif
